...
file = FileReaderClass('/Users/zhengwei/Desktop/province.xml')

datas = file.readDatas(keys=['PROVINCEID', 'PROVINCENAME', 'CREATETIME', 'UPDATETIME', 'DISTRICTID'],
                       handler={
...
insert = Insert("INSERT INTO provinces(id,name,created_at,updated_at,districts_id)",
                ['PROVINCEID', 'PROVINCENAME', 'CREATETIME', 'UPDATETIME', 'DISTRICTID'])
